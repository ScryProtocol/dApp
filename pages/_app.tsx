        ...
        <WagmiConfig client={wagmiClient}>
          <RainbowKitProvider chains={chains}>
            ...
            <div style={{ color: '#00ff55' }} className="flex flex-col bg-gray-800 space-y-6 justify-center mt-6 md:mt-12 px-4 xs:px-0 m-auto max-w-4xl min-w-80 shadow-md rounded-md border border-solid border-green-500 overflow-hidden">
              ...
              <Button onClick={window.location.replace('https://docs.scry.finance/docs/morpheus/morpehus') } style={{ color: '#77ff8b' }}variant='outlined'className="m-auto text-center w-80 bottom-4 color-green-500 border-green-500">Morpheus Docs</Button>
