...
const contractAddress = '0xFbE56581aE38746FE6C64e2cc837119a8607f626';
...
function App() {
  ...
  const createGame = async () => {
    const signer = provider.getSigner()
    const tx = await contract.connect(signer).createGame(gameId, ethers.utils.parseEther(amount),player2);
    await tx.wait();
    setGameId(gameId);
  };
        ...
        <div style={{ color: '#00ff55' }} className="flex justify-center">
          ...
          <div className="m-auto text-center color-green-500 text-1xl md:text-1xl font-bold w-3/4">
            ...
            <div className="m-auto justify-center text-center space-x-6 space-y-1">
              ...
              <input type="text" style={{ backgroundColor: '#111111', right: '2px' }}placeholder="Your message" value={commit} onChange={(e) => setCommit(e.target.value)} />
          ...
          <div className="justify-center text-center space-x-6">
            ...
            <input type="text" style={{ backgroundColor: '#111111', color: 'green', top: '1px' }} className="m-auto justify-center text-center bg-green-500" placeholder="Whitelist player only" onChange={(e) => setPlayer2(e.target.value)} />
