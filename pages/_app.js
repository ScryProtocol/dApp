...
import { base, holesky, mainnet, optimism, polygon, sepolia,scroll,arbitrum,ink,soneium } from 'wagmi/chains'
...
const config = getDefaultConfig({
  chains: [base, mainnet],//holesky,mainnet//,optimism, polygon,scroll,arbitrum,ink,soneium],// sepolia, holesky, base, optimism],
