...
const contractAddress = '0xcA32e6d8508A36aECA97EaaD2f9A4961F934E5cF'//'0x00000000000526B3a03EBf530F37fdAa3520f7B2';
...
function App() {
    ...
    const initializeEthers = async () => {
      if (window.ethereum) {
        try {
          ...
          setBountyId(Number(await contract.myBounty(await signer.getAddress())));
  ...
  const fetchUserBounties = async () => {
    ...
    const vainContractAddress = '0xcA32e6d8508A36aECA97EaaD2f9A4961F934E5cF'//'0x00000000000526B3a03EBf530F37fdAa3520f7B2';
