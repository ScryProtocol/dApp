...
const contractAddress = '0xC44459A9033c0079da04AF2f0EbaC90504a6C633';
...
function App() {
 ...
 const [bal, setBal] = useState("0");
  ...
  else{const tx = await contract.connect(signer).getBalance(alt, token,network, { value: ethers.utils.parseEther('0.01') });
  await tx.wait();}
  setOracleReady(1)
  };
  const update = async () => {
