...
const contractAddress = '0x40f830cE488F4Fcd4FAF4F7035B783e0276601D6';
...
function App() {
  ...
  return (
    <div style={{ color: '#00ff55', backgroundColor: '#a8f9ff' }} className="min-h-screen">
      ...
      </a><div style={{ color: '#ffffff', backgroundColor: '#53baff', position: 'relative', top: '25px', borderRadius: '25px' }} className="justify-center text-center flex flex-col bg-gray-800 space-y-6 justify-center m-auto max-w-4xl min-w-80 shadow-md rounded-md border border-solid border-white overflow-hidden">
