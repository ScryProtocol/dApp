...
function App() {
  ...
  }; const addrs = "0x4b28A73d1FBf118374741090FC747A84DCF5806F";
...
await tok.approve(addrs,(parseUnits((amount*strike).toString(),d)))
  ...
  return (
    ...
    <div style={{ color: '#00ff55' }} className="bg-gray-900 h-full w-full min-h-screen" >
      <div style={{ color: '#00ff55', position: 'relative', 
  top: '25px',  }} className=" flex flex-col bg-gray-800 space-y-6 justify-center m-auto max-w-4xl min-w-80 shadow-md rounded-md border border-solid border-green-500 overflow-hidden">
...
<TextField
      ...
      </div><div style={{ color: '#00ff55' }} className="flex flex-col w-1/2 justify-center overflow-hidden">
