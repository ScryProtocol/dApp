...
let signer = provider.getSigner(); let addrs = "0xf6075E08d38992a9dAF314336aEaA2b0c5E00C7F";
let addrsS = "0x53844F9577C2334e541Aec7Df7174ECe5dF1fCf0";
let addrst = "0x1aB960a8249C015423390d20B4E9cf6a272d5113";
...
function App() {
  ...
  async function getStake() {
    ...
    let ba = (await contract.balanceOf(await signer.getAddress()) / 10n ** 18n + await tok.balanceOf(await signer.getAddress()) / 10n ** 18n).toString()
  ...
  return (
    <div style={{ color: '#00ff55' }} className="bg-gray-900 h-full w-full min-h-screen" >
      ...
      <Button onClick={() => openOptionModal()} style={{ color: '#77ff8b' }} variant='outlined' className="m-auto text-center bottom-4 color-green-500 border-green-500">Morpheus Docs</Button>
      <Button onClick={() => getStake()} style={{ color: '#77ff8b' }} variant='outlined' className="m-auto text-center bottom-4 color-green-500 border-green-500">Morpheus Docs</Button>
    </div>
  )
}
