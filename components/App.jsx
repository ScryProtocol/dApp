...
function App() {
  ...
  return (
    <div style={{ color: '#00ff55', backgroundColor: '#a8f9ff', display: 'flex', flexDirection: 'column', minHeight: '100%' }} className="min-h-screen">
      ...
      </a></div><div><Button style={{ backgroundColor: '#ff97c8', color: '#ffffff', position: 'fixed',top: '42px' }} variant='outlined' className="w-28 top-12 right-2 color-white border-white" onClick={() =>{window.location.replace('https://collab.signet.art')}}>Collab</Button>
      <Button style={{ backgroundColor: '#c060ff', color: '#ffffff', position: 'fixed' ,top: '78px'}} variant='outlined' className=" right-2 color-white border-white" onClick={() =>{window.location.replace('https://collab.signet.art')}}>the wall</Button>
