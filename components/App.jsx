...
const ShareButton = ({ title, text, url }) => {
  ...
  return (
    <div style={{ color: '#00ff55', backgroundColor: '#a8f9ff', display: 'flex', flexDirection: 'column', minHeight: '100%' }} className="min-h-screen">
      ...
      <Button style={{ backgroundColor: '#c060ff', color: '#ffffff', position: 'fixed' ,top: '78px'}} variant='outlined' className=" right-2 color-white border-white" onClick={() =>{window.location.replace('https://tagthewall.org/')}}>the wall</Button>
