...
function Loan({info, i, fundLoan, drawDown, repayLoan, redeemIOUs, claimInterest, unfundLoan, updateGoal}) {
              ...
              {searchResults.map((info, i) => {
                return (
                  <Loan
                    ...
                    info={info}
                    i={i}
                    expandedRowsSearch={expandedRowsSearch}
          ...
          {myLoans.map((info, i) => {
            return (
              <Loan
                ...
                info={info}
                i={i}
                expandedRowsSearch={expandedRowsMyLoans}
                toggleExpandSearch={toggleExpandMyLoans}
              />
            );
          }
          )}
          ...
          {myIOUs.map((info, i) => {
            return (
              <Loan
                ...
                info={info}
                i={i}
                expandedRowsSearch={expandedRowsMyIOUs}
                toggleExpandSearch={toggleExpandMyIOUs}
              />
            );
          })}
        </div>
            ...
            {allLoans.map((info, i) => {
              return (
                <Loan
                  ...
                  info={info}
                  i={i}
                  expandedRowsSearch={expandedRows}
                  toggleExpandSearch={toggleExpand}
                />
              );
            }
            )}
