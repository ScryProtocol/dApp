...
contract DeathRollopen {
    ...
    function createGame(uint256 gameId, uint betAm) public {
    ...
    function joinGame(uint256 gameId, string memory _commit) public payable {
        ...
        require(
            game.betAmount == 0 ||
                msg.value == game.betAmount + 500000000000000,
        ...
        if (msg.sender == game.player1) {
            ...
            game.player1bet = msg.value - 500000000000000;
        } else {
            require(game.player2 == address(0), "Game already full");
            game.player2 = msg.sender;
            game.commit2 = _commit;
            require(game.player2bet == 0, "Already bet");
            game.player2bet = msg.value - 500000000000000;
        }

        game.betAmount = msg.value - 500000000000000;
    ...
    function swapcollector(address newcollector) public {
